      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold">
            <Link to="/" className="flex items-center justify-center gap-1">
              <span className="text-youtube-red">Video</span>
              <span>Verse</span>
            </Link>
          </CardTitle>
          <CardDescription>
            Sign in to continue to VideoVerse
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form>
            <div className="grid gap-4">
              ...
              <Button className="bg-youtube-red hover:bg-red-700">Sign In</Button>
            </div>
          </form>
        ...
        <CardFooter className="flex flex-col items-center gap-2">
          <div className="text-sm text-muted-foreground">
            ...
            <Link to="/signup" className="text-youtube-red hover:underline">
              Sign up
            </Link>
          </div>
        </CardFooter>
